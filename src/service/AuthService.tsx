...
export const customerLogin = async (phoneNo: string) => {
    try {
        ...
        const { data } = await axios.post(`http://192.168.1.74:8000/api/v1/customer/login`, { phone: phoneNo })
...
export const refresh_token = async () => {
    try {
        ...
        const { data } = await axios.post(`http://192.168.1.74:8000/api/v1/refreshToken`, { refreshToken })
